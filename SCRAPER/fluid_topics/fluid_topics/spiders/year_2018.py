...
# Helper functions to create a list of dates for 2018 - So far it's Feb
...
class Year2018Spider(scrapy.Spider):
	name = 'year_2018'
	allowed_domains = ['johnsoncontrols.fluidtopics.net']
	start_urls = ['http://johnsoncontrols.fluidtopics.net/']

	annual_list_2018 = (create_annual_list_2018())

	# Year 2018 has to be scraped monthly
	def parse(self, response):
		...
		for date in self.annual_list_2018:
			self.driver.get(
