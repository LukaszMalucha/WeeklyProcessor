...
"""
FILLING PRODUCT BRAND GAPS THEN PRODUCT NAMES
"""

dataset['get_name'] = np.where((dataset['brand'] == "Not Specified") & (dataset['product_name'] == "Not Specified"), dataset['document_title'], "Not Specified")
