...
erratic = dataset[dataset['product_name'].str.contains('1/2 through 2 in.')]
...
check = dataset[dataset['product_name'].str.contains('AMS-1090 Bumper Kit')]
...
products_unique = list(dataset['product_name'].unique())
erratic = dataset[dataset['product_name'].str.contains('other choices available')]
