...
#    dataset.to_json('documents_cleaned.json', orient='records', lines=True)
    ...
    # SAVE AS CSV
    dataset.to_csv('3_documents_cleaned.csv',  encoding='utf-8-sig', index=False)
...
data = dataset_cleaner("2_documents_processed.csv")


# check

dataset = pd.read_csv("2_documents_processed.csv", encoding='utf-8-sig')
dataset = pd.read_csv("3_documents_cleaned.csv", encoding='utf-8-sig')
