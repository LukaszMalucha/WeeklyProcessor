...
def clean_products_splitter(filename):
    ...
    dataset.to_csv("5_documents_splitted_products.csv",  encoding='utf-8-sig', index=False)
...
data = clean_products_splitter("4_documents_gaps_filled.csv")    
...
dataset = pd.read_csv("5_documents_splitted_products.csv", encoding='utf-8-sig')
